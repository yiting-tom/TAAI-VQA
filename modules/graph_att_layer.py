...
class GraphSelfAttentionLayer(nn.Module):
    ...
    def forward(self, roi_feat, adj_matrix,
        ...
        # For implicit relation (which is not used in our work)
        ...
        # aff_softmax, [batch_size, num_rois, fc_dim=num_heads, nongt_dim]
...
class GAttNet(nn.Module):
    ...
    def forward(self, v_feat, adj_matrix, pos_emb=None, show_att=False):
        """
        Args:
