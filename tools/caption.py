    ...
    with torch.no_grad():
        ...
        for i in range(batch_size):
            ...
            while True:
                ...
                if (
                    prev.word == vocab_list.index("<end>") or prev.length >= c_len
                ) and prev.prev != None:
                ...
                # Decode
                h, distribution, _ = model.generator.decode(
                    v=v, prev=encode, v_mean=v_mean, h=h
                )
