...
class VQACaptionDataset(VQADataset):
    ...
    def __init__(
        ...
        """
        super().__init__(
            load_path, feature_path, dataset_name, vocab_list, ans_list, graph_path
        )
        self.vocab_list = vocab_list
        if caption_path != "":
            print("load captions")
